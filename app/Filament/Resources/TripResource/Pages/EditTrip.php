...
class EditTrip extends EditRecord
{
    ...
    protected function afterCreate(): void
    {
        ...
        // Delete existing expenses for this trip
        $deletedExpensesCount = Expenses::where('trip_id', $tripId)->delete();
        Log::info("Deleted $deletedExpensesCount existing expenses for trip ID: {$tripId}");
