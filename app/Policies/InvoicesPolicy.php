...
class InvoicesPolicy
{
    ...
    {
        return $user->can('view_any_invoices');
    }
    ...
    {
        return $user->can('delete_any_invoices');
    }
    ...
    {
        return $user->can('force_delete_invoices');
    }
    ...
    {
        return $user->can('force_delete_any_invoices');
    }
    ...
    {
        return $user->can('restore_invoices');
    }
    ...
    {
        return $user->can('restore_any_invoices');
    }
    ...
    {
        return $user->can('replicate_invoices');
    }
    ...
    {
        return $user->can('reorder_invoices');
    }
}
