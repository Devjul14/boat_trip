                ...
                <tbody>
                    @foreach($tickets as $ticket)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 text-right font-medium">{{ number_format($ticket['total_rf'], 2) }}</td>
                        </tr>
                    @endforeach
                    <tr class="border-t">
                        <td colspan="2" class="px-4 py-2 text-right font-medium text-amber-600">Total Amount</td>
                        <td class="px-4 py-2 text-right font-bold">${{ number_format($tickets->sum('total_rf'), 2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
